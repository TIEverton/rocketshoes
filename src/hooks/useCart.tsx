  ...
  const addProduct = async (productId: number) => {
    try {
      ...
      if (productInCart) {
        ...
        const productInApi = await api.get<Product>(`/products/${productId}`).then(response => response.data)
        const productInStock = await api.get<Stock>(`/stock/${productId}`).then(response => response.data)
  ...
  const updateProductAmount = async ({
    ...
    try {
      ...
      if (productInCart) {
        ...
        if (productInStock.amount > productInCart.amount || productInStock.amount > amount) {
